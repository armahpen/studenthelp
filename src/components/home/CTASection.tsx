    ...
    <section className="bg-primary py-16">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Excel in Your Studies?</h2>
          <p className="text-blue-100 mb-8 text-lg">
            Book a free consultation today and discover how we can help your child succeed in the Ghanaian educational system.
          </p>
