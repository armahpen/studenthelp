      ...
      <div className="container mx-auto px-4 md:px-6 py-16 md:py-24 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
            Student Help provides personalized academic support for students throughout Ghana, helping them excel in their studies in a supportive and culturally relevant environment.
          </p>
