  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="bg-blue-50 py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Subjects & Levels</h1>
              <p className="text-lg text-gray-700 mb-6">
                We offer comprehensive tutoring in a wide range of subjects for both primary and secondary school students.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <a href="#primary" className="bg-white text-primary px-4 py-2 rounded-md shadow-sm hover:shadow-md transition-shadow">
                  Primary School
                </a>
                <a href="#secondary" className="bg-white text-primary px-4 py-2 rounded-md shadow-sm hover:shadow-md transition-shadow">
                  Secondary School
                </a>
              </div>
            </div>
        ...
        <section id="primary" className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Primary School Subjects</h2>
        ...
        <section id="secondary" className="py-16 bg-white">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Secondary School Subjects</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
        ...
        <section className="py-16 bg-primary">
          <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
              Contact us today to discuss how our tutoring can help your child excel in their studies.
            </p>
            <Link to="/contact">
